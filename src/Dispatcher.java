    ...
    public void run() {
        ...
        while (!processList.isEmpty() || !scheduler.priorityQueue0.isEmpty() || !scheduler.priorityQueue1.isEmpty()
            ...
            if (!scheduler.priorityQueue0.isEmpty()) {
                Process tempProcess = scheduler.priorityQueue0.element();
                if (tempProcess.getState() == 0) {
                    System.out.println(tempProcess.getColor() + currentTime + " sn proses basladi (id:" + tempProcess.getId() + " Oncelik:"
                            + tempProcess.getPriority() + " kalan sure:" + tempProcess.getProcessTime() + " sn)\n");
                    ...
                    if (tempProcess.getProcessTime() == 0) {
                        ...
                        System.out.println(tempProcess.getColor() + (currentTime + 1) + " sn proses sonlandi (id:" + tempProcess.getId() + " Oncelik:"
                                + tempProcess.getPriority() + " kalan sure:" + tempProcess.getProcessTime()
                                + " sn)\n");
                    }
                } else {

                    System.out.println(tempProcess.getColor() + currentTime + " sn proses çalışıyor (id:" + tempProcess.getId() + " Oncelik:"
                            + tempProcess.getPriority() + " kalan sure:" + tempProcess.getProcessTime() + " sn)\n");
                    tempProcess.setProcessTime(tempProcess.getProcessTime() - 1);
                ...
                if (tempProcess.getProcessTime() == 0) {
                    ...
                    System.out.println(tempProcess.getColor() + (currentTime + 1) + " sn proses askida (id:" + tempProcess.getId() + " Oncelik:"
                            + tempProcess.getPriority() + " kalan sure:" + tempProcess.getProcessTime() + " sn)\n");
                }
